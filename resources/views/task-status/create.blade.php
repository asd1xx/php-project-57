...
<html lang="ru">
    <head>
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="m8lcDM2y1HnEcqyCsk9xTkRTgQsqb3no63W6EvRV">
                ...
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div class="flex items-center lg:order-2">
                            ...
                            <form id="logout-form" action="https://php-task-manager-ru.hexlet.app/logout" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="m8lcDM2y1HnEcqyCsk9xTkRTgQsqb3no63W6EvRV" autocomplete="off">                            </form>
                                            </div>
